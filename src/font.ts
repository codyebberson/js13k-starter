...
const CHARS = '0123456789ABCDEFGHILMNOPQRSTUVWXYZ,!+/:';
const GLYPHS = [
  // 0-9
  0x7b6f, 0x749a, 0x73e7, 0x79e7, 0x49ed, 0x79cf, 0x7bcf, 0x4927, 0x7bef, 0x79ef,
  // A–Z except unused J, K
  0x5bea, 0x3aeb, 0x624e, 0x3b6b, 0x72cf, 0x12cf, 0x6b4e, 0x5bed, 0x7497, 0x7249,
  0x5bfd, 0x5b7b, 0x2b6a, 0x12eb, 0x476a, 0x5aeb, 0x348e, 0x2497, 0x7b6d, 0x2b6d, 0x5fed, 0x5aad,
  0x24ad, 0x72a7,
  // , ! + / :
  0x1400, 0x2092, 0x05d0, 0x1494, 0x0410,
];
